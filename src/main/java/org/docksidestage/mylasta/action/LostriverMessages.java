 ...
 * @author FreeGen
 */
public class LostriverMessages extends LostriverLabels {
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsAssertFalseMessage(String property) {
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsAssertTrueMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsDecimalMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsDecimalMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsDigitsMessage(String property, String fraction, String integer) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsEmailMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsFutureMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsNotBlankMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsNotEmptyMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsNotNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsPastMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsPatternMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsSizeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsCreditCardNumberMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsEanMessage(String property, String type) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsLengthMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsLuhnCheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsMod10CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsMod11CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsModCheckMessage(String property, String modType, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsParametersScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsRangeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsSafeHtmlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsUrlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsRequiredMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsTypeAnyMessage(String property, String propertyType) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsTypeIntegerMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsTypeLongMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsTypeLocalDateMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsTypeLocalDateTimeMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addConstraintsTypeBooleanMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addErrorsLoginFailure(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addErrorsAppIllegalTransition(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addErrorsAppDbAlreadyDeleted(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addErrorsAppDbAlreadyUpdated(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addErrorsAppDbAlreadyExists(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addErrorsXxxxxxxxxxxxxx(String property, String arg0, String arg1) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public LostriverMessages addErrorsYyyyyyyyyyyyyy(String property, String arg1, String arg4) {
        assertPropertyNotNull(property);
