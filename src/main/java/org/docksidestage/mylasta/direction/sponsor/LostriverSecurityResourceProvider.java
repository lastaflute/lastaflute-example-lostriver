 ...
 * @author jflute
 */
public class LostriverSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public LostriverSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
