 ...
 */
public class LostriverMultipartRequestHandler implements MultipartRequestHandler {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    private static final Logger logger = LoggerFactory.getLogger(LostriverMultipartRequestHandler.class);
    ...
    protected void throwTooLongBoundarySizeException(String contentType, int boundarySize, int limitSize) {
        ...
        br.addElement(" in " + LostriverMultipartRequestHandler.class.getSimpleName() + ".");
