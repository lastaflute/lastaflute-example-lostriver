 ...
 * @author jflute
 */
public class LostriverCookieResourceProvider implements CookieResourceProvider {

    protected final LostriverConfig config;
    protected final InvertibleCryptographer cookieCipher;

    public LostriverCookieResourceProvider(LostriverConfig config, InvertibleCryptographer cookieCipher) {
        this.config = config;
