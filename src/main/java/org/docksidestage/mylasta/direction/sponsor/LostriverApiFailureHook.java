...
import org.docksidestage.mylasta.direction.sponsor.LostriverApiFailureHook.UnifiedFailureResult.FailureErrorPart;
 ...
 * @author jflute
 */
public class LostriverApiFailureHook implements ApiFailureHook { // #change_it for handling API failure
