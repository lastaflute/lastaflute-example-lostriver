 ...
 * @author jflute
 */
public class LostriverCurtainBeforeHook implements CurtainBeforeHook {
    ...
    protected DfFinalTimeZoneProvider createFinalTimeZoneProvider() {
        return new DfFinalTimeZoneProvider() {
            protected final TimeZone provided = LostriverUserTimeZoneProcessProvider.centralTimeZone;
