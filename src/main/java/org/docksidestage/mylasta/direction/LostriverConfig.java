 ...
 * @author FreeGen
 */
public interface LostriverConfig extends LostriverEnv {

    /** The key of the configuration. e.g. lostriver */
     ...
     * @return The value of found property. (NotNull: if not found, exception but basically no way)
     */
    String getCookieRememberMeLostriverKey();

    /**
     * The simple implementation for configuration.
     * @author FreeGen
     */
    public static class SimpleImpl extends LostriverEnv.SimpleImpl implements LostriverConfig {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getDomainName() {
            return get(LostriverConfig.DOMAIN_NAME);
        }

        public String getDomainTitle() {
            return get(LostriverConfig.DOMAIN_TITLE);
        }

        public String getAppStandardDatePattern() {
            return get(LostriverConfig.APP_STANDARD_DATE_PATTERN);
        }

        public String getAppStandardDatetimePattern() {
            return get(LostriverConfig.APP_STANDARD_DATETIME_PATTERN);
        }

        public String getAppStandardTimePattern() {
            return get(LostriverConfig.APP_STANDARD_TIME_PATTERN);
        }

        public String getCookieDefaultPath() {
            return get(LostriverConfig.COOKIE_DEFAULT_PATH);
        }

        public String getCookieDefaultExpire() {
            return get(LostriverConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public Integer getCookieDefaultExpireAsInteger() {
            return getAsInteger(LostriverConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public String getCookieEternalExpire() {
            return get(LostriverConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public Integer getCookieEternalExpireAsInteger() {
            return getAsInteger(LostriverConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public String getCookieRememberMeLostriverKey() {
            return get(LostriverConfig.COOKIE_REMEMBER_ME_LOSTRIVER_KEY);
        }
    }
}
